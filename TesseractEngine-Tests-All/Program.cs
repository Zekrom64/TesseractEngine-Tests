	...
	static class Program {
		...
		static void Main(string[] _) {
			...
			List<Test> tests = new() {
				...
				new() { TestFunc = TestCoreImGui.TestCoreImGuiSDLVulkan, Name = "ImGui - Core - Vulkan + GLFW" },
				new() { TestFunc = TestCoreImGui.TestCoreImGuiSDLGL, Name = "ImGui - Core - OpenGL + GLFW" }
			};
			int ntests = 0;
			int successes = 0;
